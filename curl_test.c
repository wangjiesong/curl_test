...
int main(int argc, char **argv)
{
    ...
    curl_easy_setopt(easy_handle, CURLOPT_URL, "http://10.12.2.8:7902/open/check.ashx" );
    curl_easy_setopt(easy_handle, CURLOPT_POSTFIELDS,"datajson={\"action\":\"checkid\",\"params\":{\"localonly\":1,\"btype\":\"01\",\"channelid\":\"IC\",\"idname\":\"?M㈡~V规~X~N\",\"idno\":\"320681198706280211\",\"accesskey\":\"957971E9222B1D46D8059252711E0E50\"}}" );
